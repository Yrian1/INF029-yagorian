...
#include "YagoBrito-20201160046-T1.h"
...
void testQ2()
{
    ...
    strcpy(datainicial, "20/01/2015");
    strcpy(datafinal, "04/03/2016");
    retorno = q2(datainicial, datafinal, &qtdDias, &qtdMeses, &qtdAnos);
    printf("%d\n", retorno == 1);
    printf("%d\n", qtdDias == 13);
    printf("%d\n", qtdMeses == 1);
    ...
    strcpy(datainicial, "20/01/2016");
    strcpy(datafinal, "05/03/2017");
    retorno = q2(datainicial, datafinal, &qtdDias, &qtdMeses, &qtdAnos);
    printf("%d\n", retorno == 1);
    printf("%d\n", qtdDias == 13);
    printf("%d\n", qtdMeses == 1);
    ...
    strcpy(datainicial, "20/03/2016");
    strcpy(datafinal, "05/03/2016");
    retorno = q2(datainicial, datafinal, &qtdDias, &qtdMeses, &qtdAnos);
    printf("%d\n", retorno == 4);

    strcpy(datainicial, "11/05/2016");
    strcpy(datafinal, "12/05/2016");
    retorno = q2(datainicial, datafinal, &qtdDias, &qtdMeses, &qtdAnos);
    printf("%d\n", retorno == 1);
    printf("%d\n", qtdDias == 1);
    printf("%d\n", qtdMeses == 0);
...
void testQ4()
{
    ...
    strcpy(strTexto, "Laboratorio de programacao: para ratos de programaçao");
